...
if __name__ == '__main__':
    ...
    # about architecture
    parser.add_argument('--nz', type=int, default=85, help='size of the noise latent z vector')
    parser.add_argument('--ngh', type=int, default=4096, help='size of the hidden units in generator')
    parser.add_argument('--ndh', type=int, default=4096, help='size of the hidden units in discriminator')

    # about training clswgan
    parser.add_argument('--batch_size', type=int, default=512, help='input batch size')
    parser.add_argument('--nepoch', type=int, default=20, help='number of epochs to train GAN')
    ...
    parser.add_argument('--modeldir', default='./AWA1_proto_model', help='folder to output  model checkpoints')
    ...
    # data reading
    data = util.DATA_LOADER_proto(opt)
    print("#####################################")
